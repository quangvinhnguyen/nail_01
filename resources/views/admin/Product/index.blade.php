            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="{{ action('Admin\ServicesController@create') }}" class="btn btn-round btn-default">Add new</a>
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <td>
                            <a href="{{ action('Admin\ServicesController@edit',$item->id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            {{-- <a href="{{ action('Admin\ServicesController@destroy',$item->id) }}" class="btn btn-danger btn-xs"> <i class="fa fa-trash-o"></i> Delete </a> --}}
                              {!! Form::open([
                                  'method' => 'DELETE',
                                  'action' => ['Admin\ServicesController@destroy',$item->id]
                              ]) !!}
