            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <a href="{{ action('Admin\EventsController@create') }}"
                                    ...
                                    @foreach ($items as $item)
                                        {{-- @foreach ($item->combos as $c)
                                            <tr>
                                                ...
                                                <td>{{ $c->description }}</td>
                                                <td>
                                                    <a href="{{ action('Admin\EventsController@edit', $p->id) }}" class="btn btn-info btn-xs">
                                                        <i class="fa fa-pencil"></i>
                                                        Edit
                                                    </a>
                                                    {!! Form::open([
                                                        'method' => 'DELETE',
                                                        'action' => ['Admin\EventsController@destroy', $p->id],
                                                    ]) !!}
